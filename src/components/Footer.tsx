...
export default function Footer() {
  ...
  const offset = ((100 - scrollPercent) / 100) * circumference;
            ...
            <div className="flex items-center justify-center md:justify-start gap-2 mb-4">
              <Link href="/" className="navbar-logo" title="BlogCafeAI – Official Site">
                <Image
                  ...
                  priority
                />
                <span className="sr-only">BlogCafeAI</span>
              </Link>
            </div>
            ...
            {[
              {
                ...
                title: "Site",
                links: [
                  { href: "/", label: "BlogCafeAI" },
                  { href: "/all-posts", label: "Blogs" },
              ...
              <div key={id} className="text-left">
                ...
                <ul className={`transition-all duration-300 overflow-hidden ${openDropdown === id ? "max-h-40 opacity-100 mt-2 mb-5" : "max-h-0 opacity-0"} home-page-sub-menu sm:max-h-none sm:opacity-100 sm:mt-3 space-y-2 opacity-80`}>
                  {links.map(link => (
                    <li key={link.href}>
