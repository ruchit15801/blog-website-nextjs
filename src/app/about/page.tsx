export default function AboutPage() {
    return (
        <div className="mx-auto max-w-3xl px-4 py-12">
            <h1 className="text-3xl sm:text-4xl font-bold mb-4">About Blogcafeai</h1>
            <p className="opacity-80 mb-4">
                Blogcafeai is a modern blog UI built with Next.js. It blends a premium palette with subtle motion for a delightful reading experience.
            </p>
