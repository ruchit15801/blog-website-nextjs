                            ...
                            <div style={{ position: 'sticky', top: '80px', alignSelf: 'start' }}>
                                <div className="flex flex-col items-center gap-6">
                                    <div className="relative flex items-center justify-center text-center font-bold rounded-full" style={{ width: '96px', height: '96px' }}>
                                        <svg viewBox="0 0 100 100" className="absolute inset-0 pointer-events-none" style={{ filter: 'drop-shadow(0 4px 10px rgba(114,114,255,0.25))' }}>
                                        ...
                                        <div className="flex items-center justify-center" style={{
                                            ...
                                            <span style={{ fontSize: '0.85rem', fontWeight: 700, whiteSpace: 'nowrap' }}>{article.readTime} min read</span>
                                        </div>
                                    </div>
