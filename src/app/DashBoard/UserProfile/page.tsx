                        ...
                        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 p-3 rounded-xl border border-gray-200 hover:shadow-sm transition w-full">
                            ...
                            <div className="flex-1 flex flex-col w-full">
                                <input
                                    ...
                                    className={`w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 ${isValidUrl(socialLinks.twitter) ? 'focus:ring-[#10b981] border-[#e5e7eb]' : 'focus:ring-[#f59e0b] border-[#e5e7eb]'
                                        }`}
                                />
                                <div className="text-[11px] mt-1 text-gray-400">Tip: use your handle’s public profile URL.</div>
                            </div>
                            {socialLinks.twitter && (
                                <div className="flex flex-col sm:flex-row items-center gap-2 mt-2 sm:mt-0 flex-shrink-0">
                        ...
                        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 p-3 rounded-xl border border-gray-200 hover:shadow-sm transition w-full">
                            ...
                            <div className="flex-1 flex flex-col w-full">
                                <input
                                    ...
                                    className={`w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 ${isValidUrl(socialLinks.facebook) ? 'focus:ring-[#10b981] border-[#e5e7eb]' : 'focus:ring-[#f59e0b] border-[#e5e7eb]'
                                        }`}
                                />
                        ...
                        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 p-3 rounded-xl border border-gray-200 hover:shadow-sm transition w-full">
                            ...
                            <div className="flex-1 flex flex-col w-full">
                                <input
                                    ...
                                    className={`w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 ${isValidUrl(socialLinks.instagram) ? 'focus:ring-[#10b981] border-[#e5e7eb]' : 'focus:ring-[#f59e0b] border-[#e5e7eb]'
                                        }`}
                                />
                        ...
                        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 p-3 rounded-xl border border-gray-200 hover:shadow-sm transition w-full">
                            ...
                            <div className="flex-1 flex flex-col w-full">
                                <input
                                    ...
                                    className={`w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 ${isValidUrl(socialLinks.linkedin) ? 'focus:ring-[#10b981] border-[#e5e7eb]' : 'focus:ring-[#f59e0b] border-[#e5e7eb]'
                                        }`}
                                />
